<template>
  <div v-editable="blok" :class="marginClass">
    <Wrapper>
      <Grid v-if="blok.heading || blok.sub_heading">
        <div
          class="text-center col-end-13 col-start-1 lg:col-start-2 lg:col-end-12 mx-auto pb-7"
        >
          <h3 class="text-navy font-heavy text-h4 md:text-h3 mb-4">
            {{ blok.heading }}
          </h3>
